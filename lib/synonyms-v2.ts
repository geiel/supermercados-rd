...
const base: Array<Synonym> = [
    ...
    { synonyms: ["toalla", "pano", "wipe", "toallita"], query: ["toalla", "pano", "wipe", "toallita"]},
    ...
    { synonyms: ["fregador", "fregadero"], query: ["fregador", "fregadero"], id: "fregador"},
    { synonyms: ["metal", "metálico", "metalica", "metalica"], query: ["metal", "metalic:*"], id: "metal"},
    { synonyms: ["brillo", "estropajo"], query: ["brillo", "estropajo"], complex: ["fregador", "metal"]},
    { synonyms: ["calzado", "zapato", "shoe"], query: ["calzado", "zapato", "shoe"]},
    { synonyms: ["limpiador", "cleaner", "desinfectante", "desinfectante"], query: ["limpiador", "cleaner", "desinfectant:*"]},
    { synonyms: ["toilet", "inodoro"], query: ["toilet", "inodoro"]},
