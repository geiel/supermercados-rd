...
const base: Array<Synonym> = [
    ...
    { synonyms: ["cream", "crema", "creme"], query: ["cream:*", "crem:*"], id: "cream"},
    ...
    { synonyms: ["light", "lightly", "lite", "ligera", "ligero", "menos", "reduced", "reducida", "reducido", "bajo", "baja", "low", "con poco", "con pocos", "con poca", "con pocas"], query: ["light:*", "lite", "liger:*", "menos", "reduc:*", "bajo:*", "baja", "low:*", "con & poca", "con & poco"]},
