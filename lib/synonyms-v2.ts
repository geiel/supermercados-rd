...
const base: Array<Synonym> = [
    ...
    { synonyms: ["sparking", "con gas", "gasificada", "gasificado", "sparkling", "carbonatada", "carbonatado"], query: ["sparking", "sparkling", "con & gas", "gasificad:*", "carbonatad:*"]},
    ...
    { synonyms: ["gaseosa", "soda", "refresco"], query: ["gaseosa", "soda", "refresco"]},
    ...
    { synonyms: ["jugo ya"], query: ["jugo & ya", "naranjaya", "mangoya", "pinaya", "chinolaya", "tropicalya", "fresaya", "guanabanaya"]},
